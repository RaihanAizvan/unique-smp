    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="inline-block p-8 bg-neutral-900/50 backdrop-blur-sm border-2 border-purple-600/30 rounded-2xl">
        ...
        >
          ...
          >
            <div className="w-1 h-2 bg-purple-600 rounded-full mt-2" />
          </motion.div>
        </motion.div>
      </div>
    </section>
